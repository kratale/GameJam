...
function Update () {
	...
	var directionVector = new Vector3(Input.GetAxis("Horizontal"), 0, 0); //!!!!!! WAS: Input.GetAxis("Vertical"), 0);
	...
	var camToCharacterSpace = Quaternion.identity; //!!!!!!!!!!!!Quaternion.FromToRotation(-Camera.main.transform.forward, transform.up);
